...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@400;700&family=Gideon+Roman&display=swap"
          rel="stylesheet">
    ...
    <div class="container" data-layout="container">
        ...
        <nav class="navbar navbar-light navbar-vertical navbar-expand-xl" style="display: none;">
            <script>
                ...
                // }
                document.querySelector('.navbar-vertical').classList.add(`navbar-card`);
            </script>
            ...
            <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
                <div class="navbar-vertical-content bg-white scrollbar pt-4">
                    <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('home')}}" role="button">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="nav-link-text ps-1">الموقع</span>
                                </div>
                            </a>
                            <a class="nav-link" href="{{route('admin.index')}}" role="button">
                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-chart-pie"></span></span><span
                                            class="nav-link-text ps-1">لوحة التحكم</span></div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <!-- label-->
                            <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                                <div class="col-auto navbar-vertical-label">بيانات الموقع</div>
                                <div class="col ps-0">
                                ...
                                <a class="nav-link dropdown-indicator" href="#users" role="button"
                                   ...
                                   aria-controls="users">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                ...
                                                class="nav-link-text ps-1"> جميع المستخدمين</span></div>
                                </a>
                                <ul class="nav collapse false" id="users">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.user.index')}}">
                                            <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">جميع مدير/مدرب</span></div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.user.create')}}">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">اضافة مدير/مدرب</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                            ...
                            <!-- parent pages-->
                            <a class="nav-link dropdown-indicator" href="#courses" role="button"
                               data-bs-toggle="collapse" aria-expanded="false"
                               aria-controls="courses">
                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-book-open"></span></span><span
                                            class="nav-link-text ps-1">جميع الدورات</span></div>
                            </a>
                            <ul class="nav collapse false" id="courses">
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('admin.course.create')}}">
                                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">اضافة دورة</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                @if(auth()->user()->hasRole('admin'))
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.course.trash')}}">
                                            <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">الدورات المحذوفة</span></div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                @endif
                            ...
                            <!-- parent pages-->
                            <a class="nav-link dropdown-indicator" href="#students" role="button"
                               data-bs-toggle="collapse" aria-expanded="false"
                               aria-controls="students">
                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-graduation-cap"></span></span><span
                                            class="nav-link-text ps-1">جميع الطلاب</span></div>
                            </a>
                            <ul class="nav collapse false" id="students">
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('admin.students.create')}}">
                                        <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">اضافة طالب</span></div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                @if(auth()->user()->hasRole('admin'))
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.students.trash')}}">
                                            <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">الطلاب المحذوفين</span></div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                @endif
                            ...
                            @if(auth()->user()->hasRole('admin'))
                                ...
                                <a class="nav-link dropdown-indicator" href="#categories" role="button"
                                   ...
                                   aria-controls="categories">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                ...
                                                class="nav-link-text ps-1">التخصصات</span></div>
                                </a>
                                <ul class="nav collapse false" id="categories">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.categories.index')}}">
                                            <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">جميع التخصصات</span></div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.categories.create')}}">
                                            <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">اضافة تخصص</span></div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                ...
                                <a class="nav-link dropdown-indicator" href="#emails" role="button"
                                   data-bs-toggle="collapse" aria-expanded="false"
                                   aria-controls="emails">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                    class="fas fa-mail-bulk"></span></span><span
                                                class="nav-link-text ps-1">القائمة البريدية</span></div>
                                </a>
                                <ul class="nav collapse false" id="emails">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.subscriber.index')}}">
                                            <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">جميع المسجلين</span></div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    ...
                                    {{--                                        <div class="d-flex align-items-center"><span--}}
                                    {{--                                                    class="nav-link-text ps-1">اضافة رسالة للمسجلين</span></div>--}}
                                    {{--                                    </a>--}}
                                    {{--                                    <!-- more inner pages-->--}}
                                    {{--                                </li>--}}
                        ...
                        @if(auth()->user()->hasRole('admin'))
                            <li class="nav-item">
                                <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                                    <div class="col-auto navbar-vertical-label">الاعتمادات</div>
                                    <div class="col ps-0">
                                        <hr class="mb-0 navbar-vertical-divider"/>
                                    </div>
                                </div>
                                <a class="nav-link" href="{{route('admin.approval.students')}}" role="button">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                    class="fas fa-user-check"></span></span><span
                                                class="nav-link-text ps-1">اعتماد الطلاب</span>
                                        <span class="text-danger"> ({{\App\Models\Student::whereStatus(false)->count()}})</span>
                                    </div>
                                </a>
                                <a class="nav-link" href="{{route('admin.approval.courses')}}" role="button">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                    class="fas fa-book-medical"></span></span><span

                                                class="nav-link-text ps-1">اعتماد الدورات</span>
                                        <span class="text-danger"> ({{\App\Models\Course::whereStatus(false)->count()}})</span>
                                    </div>
                                </a>
                                <a class="nav-link" href="{{route('admin.approval.registrations')}}" role="button">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                    class="fas fa-check-double"></span></span><span
                                                class="nav-link-text ps-1">اعتماد تسجيل الطلاب</span>
                                        <span class="text-danger"> ({{\App\Models\Registration::whereStatus(false)->count()}})</span>
                                    </div>
                                </a>
                                <a class="nav-link" href="{{route('admin.approval.change_students_information')}}"
                                   role="button">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                    class="fas fa-check-double"></span></span><span
                                                class="nav-link-text ps-1">اعتماد تغيير الاسماء </span>
                                        <span class="text-danger"> ({{\App\Models\ChangeStudentInformation::count()}})</span>
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                                    <div class="col-auto navbar-vertical-label">الاعدادات</div>
                                    <div class="col ps-0">
                                        <hr class="mb-0 navbar-vertical-divider"/>
                                    </div>
                                </div>
                                <a class="nav-link" href="{{route('admin.settings.index')}}" role="button">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                    class="fas  fas fa-cogs"></span></span><span
        ...
        <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand-xl" style="display: none;">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="{{route('admin.index')}}">
                <div class="d-flex align-items-center">
                    <img class="me-2"
                         src="" alt=""
                         width="40"/><span class="font-sans-serif">{{getTitle()}}</span>
                </div>
            </a>
            <div class="collapse navbar-collapse scrollbar" id="navbarStandard">
                ...
                {{--                                                        class="nav-link py-1 link-600 fw-medium"--}}
                {{--                                                        href="modules/components/progress-bar/basic.html">Basic progress--}}
                {{--                                                    bar</a><a class="nav-link py-1 link-600 fw-medium"--}}
                {{--                                                              href="modules/components/progress-bar/advance.html">Advance--}}
                {{--                                                    progress bar</a><a class="nav-link py-1 link-600 fw-medium"--}}
                ...
                {{--                                                        class="nav-link py-1 link-600 fw-medium"--}}
                {{--                                                        href="modules/components/sidepanel.html">Sidepanel</a><a--}}
                {{--                                                        class="nav-link py-1 link-600 fw-medium"--}}
            ...
            {{--                            <span class="fas fa-sun fs-0"></span></label><label--}}
        ...
        <div class="content">
                ...
                <a class="navbar-brand me-1 me-sm-3" href="{{route('admin.index')}}">
                    <div class="d-flex align-items-center">
                        <img class="me-2"
                             src=""
                             alt="" width="40"/><span
                                class="font-sans-serif">{{getTitle()}}</span></div>
                </a>
                ...
                <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link pe-0" id="navbarDropdownUser" href="#"
                           ...
                           aria-expanded="false">
                            <div class="">
                                {{--                                <img class="rounded-circle" src="{{getLogo()}}"  alt=""/>--}}
                                <p class="btn btn-link m-0">{{auth()->user()->name}}</p>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                            <div class="bg-white dark__bg-1000 rounded-2 py-2">
                                <a class="dropdown-item" href="{{route('admin.profile')}}">الصفحة الشخصية</a>
                                <a class="dropdown-item" href="{{route('admin.logout')}}">تسجيل خروج</a>
                            </div>
                        </div>
                    </li>
                </ul>
            ...
            <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand-lg" style="display: none;"
                ...
                <a class="navbar-brand me-1 me-sm-3" href="{{route('admin.index')}}">
                    <div class="d-flex align-items-center">
                        <img class="me-2" src="" alt="" width="40"/><span
                                class="font-sans-serif">{{getTitle()}}</span></div>
                </a>
                <div class="collapse navbar-collapse scrollbar" id="navbarStandard">
                    {{--                    <ul class="navbar-nav" data-top-nav-dropdowns="data-top-nav-dropdowns">--}}
                    ...
                    {{--                                                            href="modules/components/pictures/lightbox.html">Lightbox</a><a--}}
                    {{--                                                            class="nav-link py-1 link-600 fw-medium"--}}
                    {{--                                                            href="modules/components/progress-bar/basic.html">Basic--}}
                    {{--                                                        progress bar</a><a class="nav-link py-1 link-600 fw-medium"--}}
                    {{--                                                                           href="modules/components/progress-bar/advance.html">Advance--}}
                    {{--                                                        progress bar</a><a class="nav-link py-1 link-600 fw-medium"--}}
                    {{--                                                                           href="modules/components/pagination.html">Pagination</a>--}}
...
<script src="{{asset('admin/scroll/polyfill.min58be.js')}}"></script>
