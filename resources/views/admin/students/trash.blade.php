        ...
        <div class="card-body position-relative">
            <div class="row">
                ...
                <div class="col-12 d-md-flex justify-content-between align-items-center  ">
                    <div class="">
                        <form action="{{route('admin.students.trash')}}" method="get">
                            {{--                            @csrf--}}
                            <div class="d-flex gap-2 mb-3 ">
                                <input type="search" name="search" class="form-control w-auto " placeholder="بحث بالاسم او البريد"
                                       id="">
                    ...
                    <table class="table table-striped align-middle text-center overflow-hidden">
                        ...
                        @forelse($students as $student)
                            <tr class="btn-reveal-trigger">
                                ...
                                <td>
                                    <a href="{{route('admin.students.show',$student)}}" class="btn btn-outline-facebook">عرض</a>
                                    <a href="{{route('admin.students.restore',$student)}}" class="btn btn-outline-primary">استرجاع</a>
                                    <a href="{{route('admin.students.force_delete',$student)}}" class="btn btn-outline-danger">حذف</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="11">لا يوجد طلاب محذوفين</td>
                            </tr>
                        @endforelse
                        </tbody>
                    </table>
