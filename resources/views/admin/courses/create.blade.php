                            ...
                            <form class="row g-3 " method="post" action="{{route('admin.course.store')}}"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-control" id="instructor" name="instructor"
                                           value="{{old('instructor')}}" type="text"/>
                                </div>
                                @error('instructor')
                                <span class="alert alert-danger" role="alert">{{$message}}</span>
                                @enderror
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-control" id="instructor_en" name="instructor_en"
                                           value="{{old('instructor_en')}}" type="text"/>
                                </div>
                                @error('instructor_en')
                                <span class="alert alert-danger" role="alert">{{$message}}</span>
                                @enderror
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-control datetimepicker" name="from" value="{{old('from')}}"
                                           id="from" type="text"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-control datetimepicker" name="to" value="{{old('to')}}" id="to"
                                           type="text"
                                           placeholder="d/m/y" data-options='{"disableMobile":true}'/>
                                </div>
                                @error('to')
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-control numInputWrapper" name="hours" value="{{old('hours')}}"
                                           id="hours" min="0"
                                           type="text"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-control numInputWrapper" name="days" value="{{old('days')}}"
                                           id="days" min="0"
                                           type="text"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-control datetimepicker" name="publishdate"
                                           value="{{old('publishdate')}}" id="publishdate"
                                           type="text"
                                           placeholder="d/m/y" data-options='{"disableMobile":true}'/>
                                </div>
                                @error('publishdate')
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-control numInputWrapper" name="price" value="{{old('price')}}"
                                           id="price" min="80"
                                           type="text"
                                           required
                                ...
                                <div class="col-12 d-flex ">
                                    <button class="btn btn-primary col-6 col-sm-4 mx-auto" type="submit">إضافة</button>
                                </div>
                            </form>
                        </div>
                    </div>
