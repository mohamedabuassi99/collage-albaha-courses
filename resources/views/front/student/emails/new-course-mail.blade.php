                        ...
                        <table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td class="img m-center"
                                                                        ...
                                                                        <img src="{{asset('/images/bu-logo-2020-ar.webp')}}"
                                                                             width="191" height="70"
                                                                             style="max-width:191px;" border="0"
                                                                             alt=""/></td>
                                                                </tr>
                                                            </table>
                                                        </th>
                                                                    ...
                                                                    <td class="text-header right"
                                                                        ...
                                                                        <div><a href="#"
                                                                                ...
                                                                                style="color:#000001; text-decoration:none;"><span
                                                                                        class="link"
                                                                                        style="color:#000001; text-decoration:none;">Online Certification</span></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td class="h2 center pb10"
                                                                ...
                                                                <div>تم اضافة دورة
                                                                    <br/><strong>{{@$course->name??@$course->name_en}}</strong>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="h5 center blue pb30"
                                                                ...
                                                                @if(@$course->from)
                                                                    <div>
                                                                        تاريخ بداية الدورة:{{$course->from}}
                                                                    </div>
                                                                @endif
                                                                @if(@$course->to)
                                                                    <div>
                                                                        تاريخ نهاية الدورة:{{$course->to}}
                                                                    </div>
                                                                @endif
                                                                @if(@$course->hours)
                                                                    <div>
                                                                        عدد ساعات الدورة:{{$course->hours}}
                                                                    </div>
                                                                @endif
                                                                @if(@$course->days)
                                                                    <div>
                                                                        عدد ايام الدورة:{{$course->days}}
                                                                    </div>
                                                                @endif
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="h5 center blue pb30"
                                                                style="font-family:'Ubuntu', Arial,sans-serif; font-size:20px; line-height:26px; text-align:center; color:#000000; padding-bottom:30px;">
                                                                <div>مرفق لكم رابط الموقع في حال كنت تود بالتسجيل
                                                                    للدورة.
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="fluid-img pb40"
                                                                ...
                                                                {{--                                                                <img src="images/t_free_image1.jpg" width="590" height="300"  style="max-width:590px;" border="0" alt="" />--}}
                                                            </td>
                                                        </tr>
                                                        <!-- Button -->
                                                        <tr>
                                                                ...
                                                                <table width="120" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-button"
                                                                            style="background:#ee817a; color:#ffffff; font-family:'Fira Mono', Arial,sans-serif; font-size:14px; line-height:18px; text-align:center; padding:12px;">
                                                                            <div><a href="{{url('/course/'.@$course->id)}}"
                                                                                    target="_blank"
                                                                                    class="link-white"
                                                                                    style="color:#ffffff; text-decoration:none;"><span
                                                                                            class="link-white"
                                                                                            style="color:#ffffff; text-decoration:none;">اضغط هنا</span></a>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                            ...
                                            <tr>
                                                <td class="fluid-img img-center pb70"
                                                    style="font-size:0pt; line-height:0pt; text-align:center;"><img
                                                            ...
                                                            style="max-width:590px;" border="0"
                                                            alt=""/></td>
                                            </tr>
                                        </table>
                                    </div>
                            ...
                            <tr>
                                <td class="text-footer"
                                    style="padding: 30px 15px; color:#9fadd4; font-family:'Fira Mono', Arial,sans-serif; font-size:12px; line-height:22px; text-align:center;">
                                    <div>{{config('app.name')}} &copy; {{now()->year}} كل الحقوق محفوظة <br/>
                                    </div>
                                    <div>
                                        <a href="{{url('/un-subscribe/').'/'.@$subscriber->email}}"
                                           style="text-decoration: underline;">إلغاء الاشتراك من رسائل البريد الإلكتروني
                                            المستقبلية</a>
                                    </div>
                                </td>
                            </tr>
