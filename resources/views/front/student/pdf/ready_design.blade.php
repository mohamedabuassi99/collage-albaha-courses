        ...
        <table style="width:100%;  top:-10%;">
            ...
            <tr style="">
                <td colspan="6"
                    style="height:auto; padding-top:5px; padding-bottom: 10px; font-size:20px; text-align: center; ">
                    <p class="mb-0" style="">
                        @if(auth('student')->user()->id_number)
                            <span>رقم الهوية:</span>
                            <span>{{auth('student')->user()->id_number}}</span>
                        @endif
                        @if(auth('student')->user()->nationality)
                            <span>الجنسية:</span>
                            <span>{{auth('student')->user()->nationality}}</span>
                        @endif
                    </p>
                </td>
            </tr>
                ...
                <td colspan="6"
                    ...
                    <p class="mb-0" style="">
                        @if(auth('student')->user()->id_number)
                            ...
                            <span>{{auth('student')->user()->id_number}}</span>
                        @endif
                        @if(auth('student')->user()->nationality_en)
                            <span>Nationality:</span>
                            <span>{{auth('student')->user()->nationality_en}}</span>
                        @endif
                    </p>
                </td>
            </tr>
            ...
            <tr style=" height: 40px;" width="">
                <td colspan="3"
                    ...
                    <p class="" style="font-size: 30px; ">
                        بان المتدرب/ة  {{auth('student')->user()->name}}</p>
                </td>
                <td colspan="3"
                    style=" height:auto; line-height: 30px; width: 350px; font-size:20px; text-align: center; ">
                    <p class="m-0 "
                    ...
                    <p class=""
                       style="font-size: 30px; ">
                        That the trainee {{auth('student')->user()->name_en}}</p>
                </td>
            </tr>
