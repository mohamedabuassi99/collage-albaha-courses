...
<img src="{{ asset('/img/temporary_print.jpg') }}" alt="" class="">
<div style="position: absolute; text-align: center; top:22%; ">

    <table style="width:100%; margin-right:100px; margin-left:100px;">
        <tr>
            <td style="color:#222; font-size:50px;  height:180px; padding-left:245px; ">{{$register->student->name}}</td>
        </tr>
        <tr>
            <td style="color:#222; font-size:50px;  height:100px; padding-left:245px; ">{{$register->course->name}}</td>
        </tr>
        <tr>
            <td style="text-align:center; padding-top:80px; padding-left:30px; height:230px; padding-left:280px;">
                ...
                <p style="color:#2261a9; font-size:15px; margin-top:5px; font-family:Lateef; ">هذه الشهادة معتمدة
                    إلكترونيا </p>
            </td>
        </tr>
    </table>
